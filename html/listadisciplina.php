...
$disciplina = (array) SelectQuery::select()->from('disciplina')->fetchAll();
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tb_disciplina">
                            <thead>
                                <tr>
                                    <th>Código</th>
                                    <th>Disciplina</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($value['ativo'] == true) ? 'Ativo' : 'Inativo'; ?></td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="basic example">
                                                <a href="<?php '/disciplina.php?id=' . $value['id']; ?>" class="btn btn-outline-warning">
